...
Route.post("/api/s3/signed-url", [auth_1.default, rateLimit_1.uploadRateLimit], S3Controller_1.default.getSignedUrl);
Route.get("/api/s3/public-url/:fileKey", [rateLimit_1.apiRateLimit], S3Controller_1.default.getPublicUrl);
Route.get("/api/s3/health", [rateLimit_1.apiRateLimit], S3Controller_1.default.health);
Route.get("/login", AuthController_1.default.loginPage);
Route.post("/login", [rateLimit_1.authRateLimit], AuthController_1.default.processLogin);
Route.get("/register", AuthController_1.default.registerPage);
Route.post("/register", [rateLimit_1.createAccountRateLimit], AuthController_1.default.processRegister);
...
Route.post("/forgot-password", [rateLimit_1.passwordResetRateLimit], AuthController_1.default.sendResetPassword);
Route.get("/reset-password/:id", AuthController_1.default.resetPasswordPage);
Route.post("/reset-password", [rateLimit_1.authRateLimit], AuthController_1.default.resetPassword);
