...
- [[sources/obs-2026-07-17-handler-files-konsisten-pakai-inertia-instance-api]] — "Observation: Handler files konsisten pakai inertia instance API" *(created: 2026-07-17)*
- [[sources/obs-2026-07-17-hyper-express-inertia-v1-1-0-published-with-built-in-templat]] — "Observation: hyper-express-inertia v1.1.0 published with built-in template customization" *(created: 2026-07-17)*
- [[sources/obs-2026-07-17-hyper-express-inertia-v1-3-0-dengan-inertia-v3-html-render]] — "Observation: hyper-express-inertia v1.3.0 dengan Inertia v3 HTML render" *(created: 2026-07-17)*
