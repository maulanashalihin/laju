...
**Example prompt:**
```
Based on the README.md, create a detailed TODOLIST.md with all implementation tasks.
Break down the work into small, actionable items organized by:
- Database setup (migrations)
- Backend (controllers, services, routes)
- Frontend (pages, components)
- Integrations (email, S3, OAuth)
...
- [ ] Add file upload service for S3
